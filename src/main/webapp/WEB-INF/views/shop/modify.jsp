        ...
        <div class="buypage">
            <div class="imagepage" style="text-align:left ">
               ...
               <div class="uploadResult">
                ...
                <li data-path='${img.uploadPath}' data-uuid='${img.uuid }' data-filename='${img.fileName }'>
           		<img src="/display?fileName=${img.uuid}_${img.fileName}" alt="can't find" width="100%" height="auto"padding="0px">
            	<button type='button' class='btn btn-squre btn-black' style='width:50px;, height:30px;' data-file='${img.uuid}_${img.fileName}' data-uuid='${img.uuid }'>x</button>
            	</li>
            </c:forEach>
	           <ul>
	           </ul>
            ...
            <form action="" class="infopage" method="post" role="form">
                    <div class="pro-info1">
                        <h2>상품명</h2>
                        <input type="text" name="productname" class="input-info" placeholder="상품명을 입력해 주십시오." required="required"  value="${vo.productname }">
                        <p class="font-accent" style="padding: 0px">상품가격</p>
                        <input type="text" name="price" class="input-info" placeholder="상품가격을 입력해 주십시오." required="required" value="${vo.price }">
                        <p class="font-accent" style="padding: 0px">상품설명</p>
                        <textarea name="explanation"cols="30" rows="10">${vo.explanation }</textarea>
                    </div>
                    <li></li>
            				 ...
            				 //var oriPath = element.uploadPath+"//"+element.uuid+"_"+element.fileName
             				 //oriPath = oriPath.replace(new RegExp(/\\/g),"/");
            					 ...
            					 str += "<img src='/display?fileName="+fileCallPath+"' width='100%' height='100%'>";
               					 str += "<button type='button' class='btn btn-squre btn-black' style='width:50px;, height:30px;' data-file='"+fileCallPath+"' data-type='file'>x</button>";
            				  	 str +="</li>"; 
            					 $("#default").hide();
