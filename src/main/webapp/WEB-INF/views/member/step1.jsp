...
<style>
    ...
    <script>
    	let msg='${msg}'
    	if(msg=='false'){
    		alert("약관동의를 체크 해 주십시오.");
    	}
    </script>
<body>
<div class="container">
                <a href="/">
                    <img src="/resources/images/1.png" alt="can't find" width="70px" height="auto" style="padding: 20px 0px;">
                </a>
<form action="step2" method="post">	
	<div class="form-group">
	    <label for="textarea1" id="textarea1" style="font-size:18px;">회원가입약관</label>
	    <textarea class="form-control" id="textarea1" rows="20" readonly style="background-color: white">
제 1 장 총칙
...
<input type="checkbox" name="agree" value="true" required> 약관동의
</label>
<input type="submit" class="btn btn-primary btn-sm" value="다음단계">
      <a role="button" href="/" class="btn btn-secondary">뒤로</a>
</form>	
</div>
</body>
</html>
